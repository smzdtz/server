...
// 			"ValueRanking": "2|red",
// 			"Total": "120",
// 			"ValueTotalScore": "优秀|red",
// 			"ReportDate": "2021/9/30 0:00:00",
// 			"ReportType": "1",
// 			"ProfitabilityScore": "出色|red",
// 			"GrowUpScore": "较好|red",
// 			"OperationScore": "良好|red",
// 			"CashFlowScore": "充足|red",
// 			"ValuationScore": "处于行业均值附近"
// 		},
// 		"JiaZhiPingGu_WuWeiTuList": [{
// 			"ReportDate": "2021年三季",
// 			"ReportType": "报",
// 			"ProfitabilityScore": "27.95",
// 			"GrowUpScore": "12.9",
// 			"OperationScore": "14.93",
// 			"CashFlowScore": "19.35",
// 			"ValuationScore": "5.32"
// 		}, {
// 			"ReportDate": "2020年三季",
// 			"ReportType": "报",
// 			"ProfitabilityScore": "29.67",
// 			"GrowUpScore": "18.06",
// 			"OperationScore": "14.65",
// 			"CashFlowScore": "18.49",
// 			"ValuationScore": "5.32"
// 		}]
// 	},
...
func (e EastMoney) QueryJiaZhiPingGu(ctx context.Context, secuCode string) (Result, error) {
	fc := e.GetFC(secuCode)
	apiurl := "https://emstockdiag.eastmoney.com/api/ZhenGuShouYe/GetJiaZhiPingGu"
	reqData := map[string]interface{}{
		"fc": fc,
	}
	req, err := http.NewHTTPJSONReq(ctx, apiurl, reqData)
	if err != nil {
		return Result{}, err
	}
	resp := RespJiaZhiPingGu{}
	err = http.HTTPPOST(ctx, e.HTTPClient, req, &resp)
	if err != nil {
		return Result{}, err
	}
	if resp.Status != 0 {
		return Result{}, fmt.Errorf("%s %#v", secuCode, resp.Message)
	}
